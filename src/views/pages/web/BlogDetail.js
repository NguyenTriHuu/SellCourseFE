...
function BlogDetail() {
    ...
    useEffect(() => {
        axiosPrivate
            .get(`/api/blog/${location?.state?.idBlog}/read`)
    ...
    useEffect(() => {
        setNumOfLike(data?.numOfInteract);
    }, [data]);

    useEffect(() => {
        setNumOfComment(data?.numOfComment);
    }, [data]);

    const handleChangeNumOfComment = (newValue) => {
        setNumOfComment(newValue);
    };
    ...
    const handleChangeLike = () => {
        !liked ? setNumOfLike(numOfLike + 1) : setNumOfLike(numOfLike - 1);
        let url = `/api/blog/dis-like/${data?.id}/${data?.idUser}`;
        if (!liked) {
            url = `/api/blog/like/${data?.id}/${data?.idUser}`;
        }
        ...
        <div className="grid">
            <div className="row">
                <div className="col l-9">
                    <h1 className="mt-3 mb-2">{data?.title}</h1>
                        ...
                        <div className="flex">
                            <div className="flex gap-4">
                                ...
                                >
                                    ...
                                    ></path>
                                    <path
                                        d="M222.96,9.99c2.73-.73,5.48-1.42,8.24-2.06-2.76,.65-5.51,1.33-8.24,2.06Z"
                                        fill="gray"
                                    ></path>
                                    <path
                                ...
                                <div className="flex flex-col gap-1">
                                    <div className="flex gap-3 items-center -mt-1">
                                        <p className="font-semibold cursor-pointer">Super Petya</p>
                                    </div>
                    ...
                    <div className="w-full mt-5" ref={commentRef}>
                        <Comment3 idblog={location?.state?.idBlog} onChangeNumOfComment={handleChangeNumOfComment} />
                    </div>
                </div>
                <div className="col l-3">
                    <div className="like-dislike-container">
                        <p className="text-content">What did you think of this post?</p>
                        <div className="icons-box">
                            <div className="icons">
                                <label className="btn-label" htmlFor="like-checkbox">
                                    <span className="like-text-content">{numOfLike}</span>
                                    <input
                                        className="input-box"
                                        id="like-checkbox"
                                        type="checkbox"
                            ...
                            <div className="icons">
                                <label className="btn-label" htmlFor="dislike-checkbox">
                                    <input className="input-box" id="dislike-checkbox" onClick={handleClickComment} />
                                    <TextsmsOutlinedIcon sx={{ marginRight: '7px' }} />
                                    <span className="dislike-text-content">{numOfComment}</span>
                                </label>
                            </div>
                        </div>
                    </div>
