...
function Comment() {
    ...
    return (
        <>
            <div className="bg-white w-full sm:max-w-7xl h-auto shadow px-3 py-2 flex flex-col space-y-2">
                <div className="flex items-center space-x-2">
                    <div className="group relative flex flex-shrink-0 self-start cursor-pointer">
                        ...
                        />
                        {open1 && (
                            <div className="absolute mt-8 bg-white px-4 py-4 w-72 shadow rounded cursor-default z-10">
                                <div class="flex space-x-3">
                                    <div class="flex flex-shrink-0">
                                        <img
                                            src="https://images.unsplash.com/photo-1507965613665-5fbb4cbb8399?ixid=MXwxMjA3fDB8MHx0b3BpYy1mZWVkfDQzfHRvd0paRnNrcEdnfHxlbnwwfHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"
                                            alt=""
                                            class="h-16 w-16 object-fill rounded-full"
                                        />
                                    </div>
